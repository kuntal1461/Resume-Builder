...
export default function AppShell({
  ...
  const isRouteActive = (target?: string) =>
    target ? normalizePath(target) === currentPath : false;
        ...
        >
          ...
          >
            <p className={styles.profilePrompt}>
              Complete your profile and get the most out of your personalized
              experience.
            </p>
        ...
        >
          <ul className={styles.menu}>
            {menuItems.map((item) => {
              ...
              const isExpanded =
                hasSubmenu &&
                (activeMenu === item.label || itemHasActiveChild(item));

              const linkClasses = `${styles.menuLink} ${
                isRouteActive(item.href) || itemHasActiveChild(item)
              ...
              const commonLinkProps = {
                ...
                onFocus: () =>
                  hasSubmenu ? setActiveMenu(item.label) : undefined,
              };
              const linkContent = (
                <>
                  {item.icon ? (
              ...
              return (
                <li
                  ...
                  onMouseLeave={() =>
                    hasSubmenu ? setActiveMenu(null) : undefined
                  }
                >
                  {item.href ? (
