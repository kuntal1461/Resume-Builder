...
export const DEFAULT_PROFILE_TASKS: AppProfileTask[] = [
  {
    delta: "+10%",
    label: "Confirm your target role",
    href: "/workspace/career-profile/profile",
  },
  {
    delta: "+40%",
    label: "Add your work experience",
    href: "/workspace/career-profile/insights",
  },
  {
    delta: "+45%",
...
export const APP_MENU_ITEMS: AppMenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        label: "My Professional Pitch",
        href: "/workspace/career-profile/pitch",
      },
      {
        label: "My AI Cover Letter",
        href: "/workspace/career-profile/cover-letter",
      },
    ],
  },
    ...
    subItems: [
      {
        ...
        href: "/workspace/career-plans/execute-a-job-search?cp_top_level=1&cp_second_level=1",
      },
      {
        label: "Brand Yourself",
        href: "/workspace/career-plans/execute-a-job-search?cp_top_level=2&cp_second_level=3",
      },
      {
        label: "Get More Meetings",
        href: "/workspace/career-plans/execute-a-job-search?cp_top_level=3&cp_second_level=7",
      },
      {
        label: "Interview and Win",
        href: "/workspace/career-plans/execute-a-job-search?cp_top_level=4&cp_second_level=11",
      },
      {
        label: "Close the Deal",
        href: "/workspace/career-plans/execute-a-job-search?cp_top_level=5&cp_second_level=12",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subItems: [
      {
        label: "Custom Career Plan",
        href: "/workspace/career-plans/custom-plan",
      },
      ...
      { label: "First 90 Days", href: "/workspace/career-plans/first-90-days" },
      {
        ...
        href: "/workspace/career-plans/path-to-promotion",
      },
    ],
  },
  {
