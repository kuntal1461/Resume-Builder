...
const ADMIN_FEATURES = [
  {
    ...
    description:
      "Invite hiring managers, reviewers, and coordinators to comment on every candidate document in one view.",
  },
  {
    title: "Job-matching intelligence",
    description:
      "Compare candidate skills against open roles and push curated matches directly to interview pipelines.",
  },
  {
    title: "Compliance-ready audit trail",
    description:
      "Automatic logging + exports ensure every decision is documented for leadership reviews.",
  },
];
...
export default function AdminAccessPage() {
  ...
  const handleAdminInputChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    setAdminForm((prev) => ({
      ...prev,
      [key]: key === "email" ? value.trimStart() : value,
    }));
  };
  ...
  const handleAdminLogin = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const payload: AdminLoginResponse = await response
        .json()
        .catch(() => ({}) as AdminLoginResponse);
      ...
      if (!userPayload?.is_admin) {
        throw new Error(
          "You do not have access to the admin dashboard. Please contact support.",
        );
      }
  ...
  const renderSignupForm = () => (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <div className={styles.formGroup}>
        ...
        <input
          id="admin-signup-team"
          type="text"
          className={styles.formInput}
          placeholder="Talent Ops · APAC"
          required
        />
      </div>
      <div className={styles.formGroup}>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Secure admin controls for reviewing resumes, assigning interview pipelines, and collaborating with hiring teams."
        />
      </Head>
      <SiteHeader />
        ...
        <div className={styles.inner}>
          <section className={styles.hero}>
            ...
            <h1 className={styles.heroTitle}>
              Control every resume workflow from one admin dashboard.
            </h1>
            <p className={styles.heroCopy}>
              Grant hiring partners access, monitor candidate progress, and keep
              approvals on schedule. Sign in to manage your workspace or request
          ...
          <section className={styles.panelWrap}>
            <aside className={styles.infoPanel}>
              ...
              <p>
                Move faster with automated resume scoring, access controls, and
                instant collaboration utilities tailored for recruiting
                operations.
              </p>
            ...
            <div className={styles.authPanel}>
              <div
                ...
                role="tablist"
                aria-label="Admin authentication modes"
              >
                <button
                  type="button"
                  role="tab"
              ...
              <p className={styles.disclaimer}>
                Admin access is restricted to authorized team members. By
                continuing you agree to the security policy and confidentiality
                terms outlined in your JobMatch contract.
              </p>
            </div>
          </section>
        </div>
