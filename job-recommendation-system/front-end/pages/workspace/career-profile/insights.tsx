...
const NEXT_STEPS = [
  {
    ...
    description:
      "Add quantified outcomes for the last two launches so ATS scoring highlights business impact automatically.",
    href: "/workspace/career-profile/insights?section=impact",
  },
  {
    title: "Record a 90-second pitch",
    description:
      "Use your storytelling strength to record a reusable elevator pitch. We'll surface it on matched roles and outreach scripts.",
    href: "/workspace/career-profile/pitch",
  },
  {
    title: "Add two stakeholder quotes",
    description:
      "Collect short testimonials from design and engineering leads to reinforce your collaborative leadership theme.",
        ...
        <div className={styles.page}>
          <section className={styles.hero}>
            ...
            <p className={styles.heroSubtitle}>
              Your profile analysis surfaces the strengths to double down on and
              the levers that will unlock the next role. Refresh these insights
              as you ship new wins, capture customer impact, and gather
              ...
              {INSIGHTS.map((insight) => (
                <article key={insight.title} className={styles.insightCard}>
                  ...
                  <div className={styles.insightMeta}>
                    ...
                    <span className={styles.insightUpdated}>
                      {insight.updatedAt}
                    </span>
                  </div>
                </article>
