...
const MOCK_JOBS_DATA = {
  "cna-associate-software-engineer-2": {
    ...
    logoUrl:
      "https://media.licdn.com/dms/image/v2/D560BAQGJ_agjay4QBA/company-logo_200_200/company-logo_200_200/0/1719836711521/cna_insurance_logo?e=1764806400&v=beta&t=6L0FC4MlYoJUsxJAMxmcft_AjQBv-U5VQTL-kQTsSZY",
    description:
      "CNA Insurance is dedicated to fostering a supportive work environment where employees can thrive. The Associate Software Engineer-2 role involves assisting in the development and maintenance of application programs, focusing on business applications and integration solutions.",
    responsibilities: [
    ...
    companyInfo: {
      ...
      socialLinks: {
        ...
        crunchbase:
          "https://www.crunchbase.com/organization/cna-insurance-company",
        glassdoor:
          "https://www.glassdoor.com.au/Overview/Working-at-EI_IE121.htm",
      },
      h1bData: {
        years: [
      ...
      leadership: [
        {
          ...
          image:
            "https://images.crunchbase.com/image/upload/t_cb-default-original/bb0pq0sukxpxffx64vun",
        },
        {
          ...
          image:
            "https://images.crunchbase.com/image/upload/t_cb-default-original/dhudabu6gnpqcuw3efsp",
        },
      ],
      news: [
        {
...
type Job = (typeof MOCK_JOBS_DATA)[keyof typeof MOCK_JOBS_DATA];
...
export default function JobDetailsPage() {
  ...
  return (
    <>
      <Head>
        <title>
          {job.title} at {job.company} · JobMatch
        </title>
                ...
                <div className={styles.mainContent}>
                  ...
                  <div className={styles.section}>
                    ...
                    <p className={styles.skillHint}>
                      Find out how your skills align with this job&apos;s
                      requirements. If anything seems off, you can easily{" "}
                      <strong>click on the tags</strong> to select or unselect
                      skills to reflect your actual expertise.
                    </p>
                    <div className={styles.skillTags}>
                      {job.skills.map((skill, idx) => (
                        <span
                          key={idx}
                          className={`${styles.skillTag} ${skill.matched ? styles.matched : ""}`}
                        >
                          {skill.matched && (
                            <span className={styles.checkIcon}>✓</span>
                          )}
                    ...
                    <div className={styles.qualSection}>
                      <h4>Required</h4>
                      <ul className={styles.bulletList}>
                        {job.qualifications.required.map(
                ...
                <div className={styles.companyContent}>
                  ...
                  <div className={styles.companyIntro}>
                      ...
                      <div className={styles.companyTop}>
                        <div>
                          ...
                          <div className={styles.socialLinks}>
                            <a
                              href={job.companyInfo.socialLinks.twitter}
                              target="_blank"
                              rel="noreferrer"
                            >
                              🐦
                            ...
                            <a
                              href={job.companyInfo.socialLinks.linkedin}
                              target="_blank"
                              rel="noreferrer"
                            >
                              💼
                            ...
                            <a
                              href={job.companyInfo.socialLinks.crunchbase}
                              target="_blank"
                              rel="noreferrer"
                            >
                              📊
                            ...
                            <a
                              href={job.companyInfo.socialLinks.glassdoor}
                              target="_blank"
                              rel="noreferrer"
                            >
                        ...
                        <Image
                          ...
                          className={styles.companyLogoBig}
                          width={96}
                          height={96}
                        />
                      </div>
                    ...
                    <div className={styles.companyRight}>
                      <div className={styles.companyMeta}>
                        ...
                        <div>
                          🌐{" "}
                          <a href={job.companyInfo.website} target="_blank">
                  ...
                  <div className={styles.section}>
                    ...
                    <p className={styles.h1bHint}>
                      {job.company} has a track record of offering H1B
                      sponsorships. Please note that this does not guarantee
                      sponsorship for this specific role.
                    </p>
                    <div className={styles.h1bTrends}>
                      <h4>Trends of Total Sponsorships</h4>
                      {job.companyInfo.h1bData.years.map((year, idx) => (
                    ...
                    <div className={styles.fundingInfo}>
                      <div>
                        ...
                        <div className={styles.value}>
                          {job.companyInfo.funding.stage}
                        </div>
                      </div>
                      <div>
                        <div className={styles.label}>Total Funding</div>
                        <div className={styles.value}>
                          {job.companyInfo.funding.total}
                        </div>
                      </div>
                    </div>
                    <div className={styles.fundingRounds}>
                      {job.companyInfo.funding.rounds.map((round, idx) => (
                  ...
                  <div className={styles.section}>
                    ...
                    <div className={styles.leadershipGrid}>
                      {job.companyInfo.leadership.map((leader, idx) => (
                  ...
                  <div className={styles.section}>
                    ...
                    <div className={styles.newsGrid}>
                      {job.companyInfo.news.map((article, idx) => (
