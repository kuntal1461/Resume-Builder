...
type CuratedJob = Omit<
  CuratedJobTemplate,
  "baseTitle" | "highlightTemplate"
...
const upsertLikedJobSnapshot = (snapshot: LikedJobSnapshot) => {
  const existing = readLikedJobsStorage().filter(
...
const EXPERIENCE_OPTIONS: {
  label: string;
  value: PreferenceState["experience"];
  helper: string;
}[] = [
  {
    label: "Fresher / Entry",
    value: "Fresher",
    helper: "0-1 year, ready to learn fast",
  },
  { label: "Junior", value: "Junior", helper: "2-3 years, building depth" },
  {
    label: "Mid-level",
    value: "Mid-level",
    helper: "4-7 years, independently driving work",
  },
  { label: "Senior", value: "Senior", helper: "8+ years, leading the mission" },
];

const WORK_OPTIONS: {
  label: PreferenceState["workModel"];
...
const JOB_NATURE_OPTIONS: {
  label: PreferenceState["jobNature"];
  Icon: (props: SVGProps<SVGSVGElement>) => ReactElement;
}[] = [
...
const curatedBase: CuratedJobTemplate[] = [
  {
    ...
    logoText: "AT",
    description:
      "Join Atlassian's engineering team to build scalable backend systems that power collaboration tools used by millions worldwide. You'll work on distributed systems, APIs, and microservices while collaborating with cross-functional teams.",
    responsibilities: [
    ...
    companyInfo: {
      about:
        "Atlassian builds collaboration software that helps teams work better together. Our products include Jira, Confluence, Trello, and Bitbucket, serving over 250,000 customers worldwide.",
  ...
  },
  {
    ...
    logoText: "PA",
    description:
      "Drive growth initiatives through data-driven insights at a fast-growing YC-backed analytics startup. You'll design experiments, analyze user behavior, and work directly with leadership to scale our product.",
    responsibilities: [
    ...
    companyInfo: {
      about:
        "Pulse Analytics (YC W19) helps companies make better decisions through real-time analytics. We're a Series B startup backed by top-tier VCs, growing 300% year-over-year.",
  ...
  },
  {
    ...
    logoText: "OS",
    description:
      "Launch your product career in AI at Orbit Systems. This 6-month internship program pairs you with experienced product managers to work on cutting-edge AI products, with potential for full-time conversion.",
    responsibilities: [
    ...
    companyInfo: {
      about:
        "Orbit Systems is building the next generation of AI-powered productivity tools. Our mission is to make AI accessible and useful for everyone, from students to enterprises.",
...
export default function WorkspaceJobSearchPage() {
  ...
  const handlePreferenceChange = <Key extends keyof PreferenceState>(
    key: Key,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Answer quick questions so we can personalize your job recommendations."
        />
      </Head>
      <AppShell
        ...
        <div className={styles.jobSearchPage}>
          <div className={styles.jobSearchHero}>
            ...
            <div className={styles.jobSearchHeroContent}>
              ...
              <h1>
                Tell us the{" "}
                <span className={styles.jobSearchHighlight}>job you want</span>{" "}
                and we will craft a curated short list.
              </h1>
              <p className={styles.jobSearchHeroCopy}>
                Share your role, preferred location, and job style. Our AI
                blends employer demand, culture fit cues, and fresher friendly
                programs to surface the best opportunities.
              </p>
          ...
          <div className={styles.jobSearchLayout}>
            {isFormVisible ? (
              <form
                className={styles.jobSearchPreferenceForm}
                onSubmit={handleSubmit}
              >
                <div className={styles.jobSearchSectionTitle}>
                  <h2>Answer a few quick questions</h2>
                  <p>
                    We will use these details to personalize your job board and
                    alerts.
                  </p>
                </div>
                ...
                <div className={styles.jobSearchFieldGroup}>
                  ...
                  <p className={styles.jobSearchHelperText}>
                    Be specific so we can surface niche roles.
                  </p>
                </div>
                ...
                <div className={styles.jobSearchFieldGroup}>
                  <label
                    ...
                    className={styles.jobSearchLabel}
                  >
                    Preferred location
                  </label>
                  ...
                  <p className={styles.jobSearchHelperText}>
                    We will mix local + remote matches if you leave this blank.
                  </p>
                </div>

                <div className={styles.jobSearchFieldGroup}>
                  <span className={styles.jobSearchLabel}>
                    Experience level
                  </span>
                    ...
                    {EXPERIENCE_OPTIONS.map((option) => (
                      <button
                        ...
                        className={`${styles.jobSearchExperienceCard} ${
                          option.value === preferences.experience
                            ? styles.jobSearchExperienceCardActive
                            : ""
                        }`}
                        onClick={() =>
                    ...
                    {WORK_OPTIONS.map((option) => (
                      <button
                        ...
                        className={`${styles.jobSearchToggleButton} ${
                          option.label === preferences.workModel
                            ? styles.jobSearchToggleButtonActive
                            : ""
                        }`}
                        onClick={() =>
                          handlePreferenceChange("workModel", option.label)
                        }
                    ...
                    {JOB_NATURE_OPTIONS.map((option) => (
                      <button
                        ...
                        className={`${styles.jobSearchChip} ${
                          option.label === preferences.jobNature
                            ? styles.jobSearchChipActive
                            : ""
                        }`}
                        onClick={() =>
                          handlePreferenceChange("jobNature", option.label)
                        }
                ...
                <div className={styles.jobSearchActions}>
                  <button
                    className={styles.jobSearchPrimaryButton}
                    type="submit"
                  ...
                  <button
                    className={styles.jobSearchSecondaryAction}
                    type="button"
                    onClick={handleSkip}
                  >
                    Skip for now
                ...
                {submitted ? (
                  <p className={styles.jobSearchConfirmation} role="status">
                    🎉 Preferences saved. Your job feed will reflect these
                    filters.
                  </p>
                ) : null}
              </form>
              ...
              <div className={styles.jobSearchResults}>
                <div className={styles.jobSearchResultsHeader}>
                  <div>
                    ...
                    <p>
                      These hot jobs blend your role, location, and work-style
                      preferences for a perfect-fit short list.
                    </p>
                  </div>
                  <button
                    className={styles.jobSearchPrimaryButton}
                  ...
                  {generatedJobs.map((job) => (
                    <article key={job.id} className={styles.jobSearchJobCard}>
                      <div className={styles.jobSearchJobCardTop}>
                        <div
                          className={styles.jobSearchCompanyLogo}
                          aria-hidden="true"
                        >
                          {job.logoText}
                        </div>
                        <div className={styles.jobSearchJobDesc}>
                          <span className={styles.jobSearchPublishTag}>
                            {job.posted}
                          </span>
                          <h3
                            onClick={() =>
                              router.push(
                                `/workspace/job-search/info/${job.jobId}`,
                              )
                            }
                        ...
                        <div
                          className={styles.jobSearchMatchWidget}
                          aria-label={`Match score ${job.matchScore}%`}
                        >
                          <span className={styles.jobSearchMatchScore}>
                            {job.matchScore}%
                          </span>
                          <span className={styles.jobSearchMatchLabel}>
                            {job.matchBadge}
                          </span>
                        </div>
                      </div>
                      <div className={styles.jobSearchJobMetaGrid}>
                        {[
                          ...
                          <div
                            ...
                            className={styles.jobSearchMetaItem}
                          >
                            <item.Icon />
                            <div>
                      ...
                      <div className={styles.jobSearchJobActions}>
                        <div className={styles.jobSearchActionGroup}>
                          <div
                            className={`${styles.jobSearchDangerWrapper} ${
                              activeActionMenu === job.id
                                ? styles.jobSearchActionGroupActive
                                : ""
                            }`}
                          ...
                          >
                            ...
                            {activeActionMenu === job.id ? (
                              <div
                                className={styles.jobSearchActionMenu}
                                role="menu"
                              >
                                {[
                                  {
                          ...
                          <button
                            className={`${styles.jobSearchIconButton} ${styles.jobSearchSaveButton} ${
                              savedJobIds.includes(job.id)
                                ? styles.jobSearchSaveButtonActive
                                : ""
                            }`}
                            type="button"
                        ...
                        <button
                          className={styles.jobSearchApplyButton}
                          type="button"
                        >
                          Apply now
                        </button>
              ...
              <div className={styles.jobSearchEmptyState}>
                <div className={styles.jobSearchEmptyTop}>
                  <span className={styles.jobSearchEmptyBadge}>
                    Preferences paused
                  </span>
                  <h2>Fill your preferences to unlock jobs</h2>
                  <p>
                    We can’t show curated roles until you share the job type,
                    location, and work style you want.
                  </p>
                </div>
                <div className={styles.jobSearchEmptyHighlight}>
                  ...
                  <div>
                    ...
                    <p>
                      Your personalized matches stay hidden until we know your
                      target role.
                    </p>
                  </div>
                </div>
                <ul className={styles.jobSearchEmptyList}>
                  ...
                  <li>
                    Choose work style and job type to unlock fresher-friendly
                    tracks.
                  </li>
                </ul>
          ...
          {expandedJobId &&
            (() => {
              const selectedJob = generatedJobs.find(
                (job) => job.id === expandedJobId,
              );
              ...
              return (
                ...
                >
                  <div
                    className={styles.jobModalContent}
                  ...
                  >
                    ...
                    <div className={styles.jobModalTopBar}>
                      ...
                      <div className={styles.jobModalTopActions}>
                        <button className={styles.iconBtn} aria-label="Hide">
                          🚫
                        </button>
                        <button
                    ...
                    <div className={styles.jobModalTabs}>
                      ...
                      <div className={styles.tabActions}>
                        ...
                        <button className={styles.tabAction}>
                          🚩 Report Issue
                        </button>
                        <button className={styles.tabAction}>
                          📄 Original Job Post
                    ...
                    <div className={styles.jobModalBody}>
                      <div className={styles.jobModalMain}>
                        ...
                        {/* Job Title */}
                        <h1 className={styles.jobTitleLarge}>
                          {selectedJob.title}
                        </h1>
