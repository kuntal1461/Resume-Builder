  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Analyze offers and benchmark salary bands."
        />
      </Head>
      <AppShell
      ...
      >
        <div className={styles.page}>
          <section
            className={styles.offerHeroSection}
            aria-label="Offer Analyzer hero"
          >
            <div className={styles.offerHeroContent}>
              <p className={styles.offerHeroEyebrow}>Negotiation co-pilot</p>
              <h1>
                Bring{" "}
                <span className={styles.offerHeroHighlightText}>
                  market proof
                </span>{" "}
                into every offer conversation.
              </h1>
              <p>
                Understand if your package is competitive before you counter.
                Blend salary benchmarks with full compensation modeling so you
              ...
              <ul className={styles.offerHeroHighlights}>
                {HERO_HIGHLIGHTS.map(({ label, Icon }) => (
                  <li key={label}>
                    <Icon
                      className={styles.offerHeroHighlightIcon}
                      aria-hidden="true"
                    />
                    {label}
                  </li>
            ...
            <div className={styles.offerHeroCard} aria-live="polite">
              ...
              <p className={styles.offerHeroLead}>
                You&rsquo;re tracking {HERO_CARD_STATS[0].value} with{" "}
                {HERO_CARD_STATS[1].value} ready for an Offer Analyzer deep
                dive.
              </p>
          ...
          <section
            aria-label="Offer Analyzer workflows"
          ...
          >
            <div className={styles.workflowIntro}>
              ...
              <p>
                Start with salary calibration, then move into total compensation
                modeling. Each workflow feeds context back into your negotiation
                plan so nothing is missed when you counter.
              </p>
            </div>
            <div className={styles.workflowGrid}>
              <article
                className={`${styles.workflowCard} ${styles.workflowPrimary}`}
              >
                <div className={styles.workflowCardHeader}>
                  <div>
                    <span className={styles.workflowStatusPill}>
                      Start here
                    </span>
                    <h3>Salary Analyzer</h3>
                    <p>
                      Benchmark market pay by role, level, and geography before
                ...
                <ul
                  ...
                  aria-label="Salary Analyzer highlights"
                >
                  <li>
                    <strong>24</strong>
                    <span>Markets</span>
                ...
                <ol className={styles.workflowSteps}>
                  <li>
                    ...
                    <p>
                      Lock level, role, and location to see low/median/high
                      salary targets.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      Compare base, bonus, and equity to understand how far you
                      are from target bands.
                    </p>
                  </li>
                  <li>
                    <span>Save your benchmark</span>
                    <p>
                      Create a baseline for the Offer Package Analyzer and
                      negotiation briefs.
                    </p>
                  </li>
                </ol>
              ...
              <article
                className={`${styles.workflowCard} ${styles.workflowSecondary}`}
              >
                <div className={styles.workflowCardHeader}>
                  <div>
                    ...
                    <p>
                      Bring in taxes, cost-of-living, and multi-offer
                      comparisons to prep the negotiation.
                    </p>
                  </div>
                  <div className={styles.workflowIconBadge} role="presentation">
                ...
                <ol className={styles.workflowSteps}>
                  <li>
                    ...
                    <p>
                      Blend base, bonus, equity, and benefits with
                  ...
                  <li>
                    ...
                    <p>
                      Stack rank each package and surface leverage talking
                      points.
                    </p>
                  </li>
                </ol>
                <Link
                  href="/workspace/offer-analyzer/offer"
                  className={styles.workflowLink}
                >
