...
const HERO_HIGHLIGHTS = [
  {
    label: "Level-calibrated bands",
    helper: "Intern → Director+",
    Icon: WorkTypeIcon,
  },
  {
    label: "Remote, hybrid, onsite aware",
    helper: "Location multipliers",
    Icon: RemoteModeIcon,
  },
  {
    label: "Offer-ready benchmarks",
    helper: "Export to negotiation plan",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Estimate fair salary ranges by role, level, and location."
        />
      </Head>
      <AppShell
      ...
      >
        <div className={styles.page}>
          <section
            className={styles.salaryHeroSection}
            aria-label="Salary Analyzer hero"
          >
            <div className={styles.salaryHeroCopy}>
              <p className={styles.salaryHeroEyebrow}>Salary Analyzer</p>
              <h1>
                Lead every salary conversation with{" "}
                <span className={styles.salaryHeroHighlight}>evidence.</span>
              </h1>
              <p>
                Calibrate the right range for your role before countering an
                offer. Blend level, geography, and work model data to chart a
                confident response.
              </p>
              <ul className={styles.salaryHeroHighlights}>
                {HERO_HIGHLIGHTS.map(({ label, helper, Icon }) => (
                  <li key={label}>
                    <div
                      className={styles.salaryHeroHighlightIcon}
                      role="presentation"
                    >
            ...
            <div className={styles.salaryHeroPanel} aria-live="polite">
              <div className={styles.salaryHeroPanelHeader}>
                Live benchmark signals
              </div>
              ...
              <div className={styles.salaryHeroPanelFoot}>
                <p>
                  Use these signals to lock your negotiation guardrails before
                  modeling a full offer.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className={styles.card} aria-label="Inputs">
            <header className={styles.formHeader}>
              <div>
                ...
                <p>
                  Pair role context with offer details to generate a
                  negotiation-ready band before you counter.
                </p>
              </div>
              <div
                className={styles.headerBadges}
                aria-label="Data coverage highlights"
              >
          ...
          {analyzed ? (
            <section className={styles.resultsGrid} aria-label="Results">
              ...
              <article className={styles.resultCard}>
                ...
                <span className={styles.metricValue}>
                  {offer.base ? `${percentile}th percentile` : "—"}
                </span>
                <div className={styles.rangeBar}>
                  <div
                ...
                <div className={styles.insights}>
                  <div className={styles.insightItem}>
                    ...
                    <span>
                      {offer.base ? fmt(offer.base) : "Enter base to compare"}
                    </span>
                  </div>
                  <div className={styles.insightItem}>
              ...
              <article className={styles.resultCard}>
                ...
                <span className={styles.metricValue}>
                  {fmt(market.max - market.min)}
                </span>
                <div className={styles.insights}>
                  <div className={styles.insightItem}>
                    <span className={styles.pill}>Tip</span>
                    <span>
                      Target {fmt(market.mid)}–
                      {fmt(Math.round(market.mid * 1.1))} if your skills align
                      with role must-haves.
                    </span>
                  </div>
                </div>
              </article>
