...
const TEMPLATE_ACTIONS = [
  {
    ...
    description:
      "Clone a proven layout, customize sections, and ship to hiring pods.",
    cta: "Create template",
  ...
  },
  {
    ...
    description:
      "Approve legal copy changes or reassign owners before publish.",
    cta: "Open queue",
  ...
  },
  {
    ...
    description:
      "Jump into the templates you have drafted or archived and pick up right where you left off.",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Oversee resume templates, approvals, and scoring automations for JobMatch."
        />
      </Head>
          ...
          <div className={styles.workspaceMain}>
            <section className={styles.dashboardHeader}>
              <div>
                ...
                <p>
                  Review ownership, approvals, and scoring signals in one place.
                  Align every template drop with the workspace overview
                  experience.
                </p>
            ...
            <section className={styles.sectionIntro}>
              ...
              <p>
                Mirror the workspace overview tone so admin tooling feels
